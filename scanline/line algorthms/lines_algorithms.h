...
void* nai_getline(figure*, coordinate, coordinate, color*); //naive algorithm
void* dda_getline(figure*, coordinate, coordinate, color*); //dda algorithm
void* bre_getline(figure*, coordinate, coordinate, color*); //bresenham algorithm
